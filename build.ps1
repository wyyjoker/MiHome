...
$NuitkaArgs = @(
    ...
    "--include-data-files=app\ui\shell\assets\room-photo-living.png=app/ui/shell/assets/room-photo-living.png"
    "--include-data-files=app\ui\shell\assets\room-photo-bedroom.png=app/ui/shell/assets/room-photo-bedroom.png"
    "--include-data-files=app\ui\shell\assets\room-photo-study.png=app/ui/shell/assets/room-photo-study.png"
